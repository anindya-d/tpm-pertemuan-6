...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ActivityUpdateData.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvAlamat = itemView.findViewById(R.id.etAlamat);
            tvJenkel = itemView.findViewById((R.id.etJenkel));
            tvNama = itemView.findViewById(R.id.etNama);
            layout = itemView.findViewById(R.id.list_data);
